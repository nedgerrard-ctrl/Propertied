...
export default function DeveloperPage({ content }: { content: DeveloperContentData }) {
  ...
  const partnershipBenefits = [
    { title: content.benefit1Title, description: content.benefit1Desc },
    { title: content.benefit2Title, description: content.benefit2Desc },
    { title: content.benefit3Title, description: content.benefit3Desc },
  ]

  const processSteps = [
    { step: '01', title: content.process1Title, description: content.process1Desc },
    { step: '02', title: content.process2Title, description: content.process2Desc },
    { step: '03', title: content.process3Title, description: content.process3Desc },
  ]
  ...
  const networkBullets = [
    content.networkBullet1,
    content.networkBullet2,
    content.networkBullet3,
    content.networkBullet4,
  ]
    ...
    <main className="min-h-screen w-full text-[#1f1a17]">
          ...
          <div className="grid min-h-[540px] lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-8 py-16 lg:px-14 xl:px-16">
              ...
              <h2 className="mt-4 text-[26px] font-light leading-[1.35] text-white sm:text-[30px]">
                {content.networkHeadingMain}{' '}
                <span className="text-[#c8a96e]">{content.networkHeadingAccent}</span>
              </h2>
          ...
          <div className="grid lg:grid-cols-[5fr_7fr] gap-16 lg:gap-24 lg:items-start">
            ...
            <div>
              ...
              <h2 className="text-3xl lg:text-[2.75rem] font-light leading-[1.2] text-[#1f1a17]">
                {content.endToEndHeading}
              </h2>
              <div className="mt-8 space-y-5 text-[13px] leading-[1.9] text-[#5b5147]">
                <p>{content.endToEndP1}</p>
                <p>{content.endToEndP2}</p>
              </div>
            </div>
      ...
      <section className="bg-[#1c1814] py-32 lg:py-44">
        <div className="mx-auto max-w-7xl px-8 text-center">
          ...
          <h2 className="mt-6 text-4xl md:text-6xl lg:text-7xl font-light text-white leading-[1.06] whitespace-pre-line">
            {content.ctaHeading}
          </h2>
