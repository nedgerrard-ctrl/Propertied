  ...
  return (
    <main className="min-h-screen bg-neutral-100 px-6 py-10">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-1 text-3xl font-semibold text-neutral-900">Edit VIP Post</h1>

        <p className="mt-1 text-sm text-neutral-500">
          Update the VIP content, upload images, or change its publish status.
        </p>

        <VipForm initialData={data} />
      </div>
    </main>
  );
}
