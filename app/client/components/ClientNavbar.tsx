...
export default function ClientNavbar() {
  ...
  const isExistingClient = session?.user?.userType === "existing_client";
  const links = isExistingClient ? [...BASE_LINKS, VIP_LINK] : BASE_LINKS;
  ...
  return (
    <aside className="sticky top-0 flex h-screen w-56 shrink-0 flex-col border-r border-neutral-200 bg-white px-4 py-6">
      ...
      <div className="mb-8 px-2">
        <p className="text-sm font-bold text-neutral-900">PPM Client Portal</p>
