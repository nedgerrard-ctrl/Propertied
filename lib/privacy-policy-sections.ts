...
export const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'bullets', bullets: [
        ...
        'Employer references, rental references (previous rental provider or property manager), and character references',
      ...
      { kind: 'paragraph', text: 'When you use our website (www.ppmproperty.com.au), we automatically collect technical information including your IP address, device type, browser type, pages visited, referring website and time on site. This information is used for security, analytics and to improve the website.' },
      ...
      { kind: 'paragraph', text: 'CDD records are retained for seven years from the end of the customer relationship as required by AUSTRAC.' },
    ],
  },
  {
    number: 3,
    ...
    blocks: [
      { kind: 'bullets', intro: 'We may collect personal information from you through any of the following:', bullets: [
        ...
        'tenancy application forms completed by prospective tenants, processed through our authorised property management platform',
  ...
  },
  {
    ...
    blocks: [
      { kind: 'bullets', intro: 'We use your personal information to:', bullets: [
        ...
        'perform customer due diligence, identity verification, and ongoing monitoring as required by AUSTRAC',
        ...
        'process tenancy applications through our authorised property management platform',
  ...
  },
  {
    ...
    blocks: [
      { kind: 'bullets', intro: 'We may disclose your personal information to:', bullets: [
        ...
        'Our customer relationship management (CRM) and AML/CTF compliance platform, which receives website enquiries, stores ongoing client correspondence and transaction records, and performs customer due diligence checks (identity matching, sanctions and PEP screening, risk scoring) on PPM’s behalf. Client data is hosted on servers located in Australia',
        ...
        'Our authorised property management platform — for tenancy application processing and record-keeping',
        ...
        'Vendors, purchasers, rental providers or tenants — only to the extent necessary to give effect to a transaction or tenancy',
  ...
  {
    number: 8,
    heading: 'Property management data processing',
    blocks: [
      { kind: 'paragraph', text: 'Tenancy application data and property management records are processed and stored through our authorised property management platform, which is bound by its own privacy policy and stores data on servers located in Australia. We have satisfied ourselves that the platform maintains appropriate data security and privacy standards consistent with the Australian Privacy Principles.' },
    ],
  },
  {
    number: 9,
    ...
    blocks: [
      { kind: 'paragraph', text: 'When you submit an enquiry, register your interest, or create a client account through the PPM website (www.ppmproperty.com.au), the personal information you provide is received by PPM staff via our business email accounts, and recorded in our customer relationship management (CRM) platform, where ongoing communications and client records are maintained.' },
      ...
      { kind: 'paragraph', text: 'PPM may offer a free client member registration that provides access to our full curated showcase of off-the-plan and established projects (including projects not displayed publicly), preferential sales commission rates available only to PPM members, and early notice of selected new opportunities and member-only incentives.' },
      { kind: 'paragraph', text: 'Registration requires your name, email address, telephone number, country of residence and a password of your choosing. Your password is stored in encrypted (hashed) form and is not visible to PPM staff. You may close your account or withdraw consent for marketing communications at any time by contacting our Privacy Officer.' },
    ],
  },
  {
    number: 10,
    ...
    blocks: [
      ...
      { kind: 'paragraph', text: 'These services may set cookies and collect online identifiers including IP addresses. You can control or disable cookies through your browser settings. You can opt out of Google personalised advertising at adssettings.google.com. We do not knowingly store cookies that contain personally identifying information.' },
    ],
  },
  {
    number: 11,
    ...
    blocks: [
      { kind: 'bullets', intro: 'We take reasonable steps to protect your personal information from misuse, interference, loss, unauthorised access, modification or disclosure. These include:', bullets: [
  ...
  },
  {
    ...
    blocks: [
      { kind: 'paragraph', text: 'We retain personal information only for as long as necessary to fulfil the purposes for which it was collected (including ongoing client relationship management within our CRM platform), meet legal, accounting and regulatory record-keeping obligations (including the seven-year retention requirement under the AML/CTF Act 2006 (Cth) and the record-keeping requirements under the Estate Agents Act 1980 (Vic)), and exercise or defend legal claims.' },
      { kind: 'paragraph', text: 'You may request deletion of your records at any time by contacting our Privacy Officer. When information is no longer required for any of the above purposes, we securely destroy or de-identify it.' },
    ],
  },
  {
    number: 13,
    ...
    blocks: [
      { kind: 'paragraph', text: 'We acknowledge our obligations under the Notifiable Data Breaches Scheme. If we suspect a data breach that is likely to result in serious harm to an affected individual, we will contain the breach and assess the harm as soon as practicable, and where required, notify the affected individual(s) and the Office of the Australian Information Commissioner.' },
  ...
  },
  {
    ...
    blocks: [
      { kind: 'paragraph', text: 'If you provide us with your email address or telephone number, we may use them to send you information about specific properties, periodic property availability and new listing notifications, newsletters covering market commentary, and updates on PPM services and member benefits.' },
      { kind: 'paragraph', text: 'Every electronic marketing message will include a working unsubscribe link. You may also withdraw consent at any time by contacting our Privacy Officer. Operational communications relating to an active service, transaction or tenancy are not marketing communications and continue regardless of marketing preferences.' },
  ...
  },
  {
    ...
    blocks: [
      { kind: 'paragraph', text: 'You have the right to request access to the personal information we hold about you; request correction of information you believe is inaccurate, out of date, incomplete, irrelevant or misleading; request that we no longer use your information for direct marketing; and request information about how your personal information has been disclosed in the previous twelve months.' },
      { kind: 'paragraph', text: 'We may charge a reasonable fee to cover administrative costs of providing copies of records. Identity verification will be required before we release personal information. If we are unable to fulfil your request, we will explain why in writing.' },
    ],
  },
  {
    number: 17,
    heading: 'Complaints',
    blocks: [
      { kind: 'paragraph', text: 'If you have a complaint about how we have handled your personal information, please contact our Privacy Officer in the first instance. We will acknowledge your complaint, conduct a thorough investigation and aim to provide a substantive response within the periods prescribed by law.' },
      { kind: 'paragraph', text: 'If you are not satisfied with our response, you may lodge a complaint with the Office of the Australian Information Commissioner (OAIC): Website oaic.gov.au · Phone 1300 363 992 · Mail GPO Box 5288, Sydney NSW 2001.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { kind: 'paragraph', text: 'The Privacy Officer · Property Project Marketing Pty Ltd T/A Online Property Services' },
      { kind: 'paragraph', text: 'Level 7, 570 St Kilda Road, Melbourne, Victoria 3004 · Email: admin@onlinepropertyservices.com.au' },
      { kind: 'paragraph', text: 'Compliance Officer (for AML/CTF matters): Ned Gerrard. Email: admin@onlinepropertyservices.com.au' },
      { kind: 'paragraph', text: 'ABN 99 162 429 558 · Estate Agents Licence No. 074846L' },
    ],
  },
]
